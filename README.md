# Spring CRUD application with Cassandra

[Cassandra](https://cassandra.apache.org/) is a free and open-source, distributed, wide-column store, NoSQL database management system designed to handle large amounts of data across many commodity servers, providing high availability with no single point of failure.
[Spring Data Cassandra](https://spring.io/projects/spring-data-cassandra) offers a familiar interface to those who have used other Spring Data modules in the past.

## Overview

*CRUD* is an acronym that comes from the world of computer programming and refers to the four functions that are considered necessary to implement a persistent storage application: *create*, *read*, *update* and *delete*.
This project shows how to use **Spring Data** to expose these functions to **Cassandra**.

The **Spring Data** for **Cassandra** project applies core Spring concepts to the development of solutions by using the Apache Cassandra NoSQL Database.
With the power to stay at a high level with annotated POJOs, or at a low level with high performance data ingestion capabilities, the Spring Data for Cassandra templates are sure to meet every application need.

In local development, you need to provide a connection to a Cassandra instance.
...
This project template uses **JUnit 5** and **Mockito** to test a **Spring REST API** using **Cassandra**.
...
- [Spring Data for Cassandra: A Complete Example](https://medium.com/@aamine/spring-data-for-cassandra-a-complete-example-3c6f7f39fef9)
